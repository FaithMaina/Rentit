...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Our Landlords</h1>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php foreach ($all_landlords as $landlord):?>
                        <tr>
                            <td><?php echo $landlord['First_name'];?></td>
                            <td><?php echo $landlord['Last_name'];?></td>
                            <td><?php echo $landlord['Username'];?></td>
                            <td><?php echo $landlord['telephone_no'];?></td>
